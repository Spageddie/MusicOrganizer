...
public class MergeData {
    ...
    public MergeData(LinkedList<Response> r, LinkedList<Song> s) {
        ...
        for (int j = 0; j < s.size(); j++) {
            ...
            for (int i = 0; i < r.size(); i++) {
                ...
                for (int k = 0; k < hobbies.size(); k++) {
                    if (r.get(i).getHobby().equals("reading")) {
                        ...
                        if (r.get(i).getLikesSongList().get(j).equals("Yes")) {
                            readLikeCount++;
                        }
            ...
            Glyph readGlyph = new Glyph("read", s.get(j), readHeardPercent.get(
                j), readLikePercent.get(j));
            Glyph artGlyph = new Glyph("art", s.get(j), artHeardPercent.get(j),
                artLikePercent.get(j));
            Glyph musicGlyph = new Glyph("music", s.get(j), musicHeardPercent
                .get(j), musicLikePercent.get(j));
            Glyph sportsGlyph = new Glyph("sports", s.get(j), sportsHeardPercent
                .get(j), sportsLikePercent.get(j));
            ...
            Glyph otherGlyph = new Glyph("Other", s.get(j), otherHeardPercent
                .get(j), otherLikePercent.get(j));
            ...
            Glyph usGlyph = new Glyph("United States", s.get(j), usHeardPercent
                .get(j), usLikePercent.get(j));
    ...
    */
    ...
    public String toString() {
        ...
        for (int i = 0; i < hobbyList.size(); i++) {
            builder.append(hobbyList.toString() + " ");
            builder.append(majorList.toString() + " ");
            builder.append(regionList.toString() + " ");
        }
